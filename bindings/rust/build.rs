...
fn main() {
    ...
    // Normalize .. components lexically (no filesystem access): canonicalize
    // would add a \\?\ prefix that MinGW gcc cannot open.
    let src = dir.join("../../src").components().collect::<PathBuf>();
